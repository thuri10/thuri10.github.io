...
![Filter GET HTTP Method](/assets/images/packets/packet_name-filter.png)
...
![Network communication flow](/assets/images/packets/networkcomm.png)
...
![Conculsion](/assets/images/packets/network.png)
