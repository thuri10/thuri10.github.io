...
draft: false
summary: Combine elements from the ret2win challenge that have been split apart to beat this challenge. Learn how to use another tool whilst crafting a short ROP chain.
layout: PostLayout
images: '/static/images/ropemporium/split.jpg'
