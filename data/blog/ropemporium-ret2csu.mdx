...
## __libc_csu_init__ Disassembly
Below is the disassembled code for **__libc_csu_init** section for the ret2csu binary using objdump tool.objdump is a linux command line tool used for disassembling binaries.
