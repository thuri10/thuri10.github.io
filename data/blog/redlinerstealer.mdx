...
draft: false
summary: Redline malware is an Information Stealer written in c# , targeting windows victims. It is used for gathering victims information ranging from cookies, credentials, Discord tokens
images: '/static/images/redline/coverpage.png'
layout: PostLayout
canonicalUrl:
---
